...
// import TimeManage from "../Content/TimeManage/PaTimeManage";
// import MoneyManage from "../Content/MoneyManage/PaMoneyManage";
// import MarkSubManage from "../Content/MarkManage/PaMarkSubManage";
...
// import PaCheckMo from "../Content/MoneyManage/ParentCheckMoney";
...
//   };
  ...
  renderContent = () => {
    ...
    case 1: return(<div></div>)
      case 2.1: return (<div className="ql"><TimeManage nowterm={this.state.term}/></div>);
    ...
    return (
      <div>
        ...
        <div className="container">
          ...
          <div className="body">
            <div className="Hello">Xin chào, Phụ huynh Sinh Viên {this.state.fullname}</div>
